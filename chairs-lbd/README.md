...
- 2025 decision: Poster required; thumbnail required; video optional; spec conflict observed; **ACL poster size (A0) worked well** and is recommended
- Recommendations: Publish a single spec table; align web/email/system; enforce at upload when possible; **use A0 poster size (ACL standard)** for consistency with other conferences
